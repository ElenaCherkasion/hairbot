...
const MAIN_MENU_TEXT =
  ...
  "HAIRbot — сервис анализа внешности и подбора наиболее удачных вариантов.\n" +
  "Сначала ты получаешь анализ, затем — визуальные варианты по запросу.\n\n" +
  "🔹 Сервис работает для женской внешности\n" +
  "🔹 Генерации — это иллюстрации к рекомендациям";

const MAIN_MENU_KB = {
  inline_keyboard: [
    [{ text: "Начать Free", callback_data: "flow_free" }],
    [{ text: "Форма + цвет", callback_data: "flow_basic" }],
    [{ text: "Форма + цвет + акцент", callback_data: "flow_pro" }],
    [{ text: "Полный образ", callback_data: "flow_premium" }],
    [{ text: "1 цвет", callback_data: "flow_colorref1" }],
    [{ text: "10 цветов", callback_data: "flow_colorref10" }],
    [
...
const PRICING_TEXT =
  ...
  "✨ BASIC — 399 ₽\n" +
  "• стрижка: 1× (4 варианта) — по кнопке\n" +
  "• цвет по Манселлу: 1× (4 варианта)\n\n" +
  "🌈 PRO — 899 ₽\n" +
  "• + генерация цвета (4)\n" +
  "• + яркие оттенки (4)\n\n" +
  "💎 PREMIUM — 1 590 ₽\n" +
  "• + биозавивка (по запросу)\n" +
  "• + серьги (рекомендации + генерация 4)\n\n" +
  "🎨 COLOR REF 1 — 99 ₽\n" +
  "• 1 генерация цвета по референсу — 1 вариант\n\n" +
  "🎨 COLOR REF 10 — 1 290 ₽\n" +
...
app.post("/webhook", async (req, res) => {
  try {
    ...
    if (update.callback_query) {
      ...
      // Тут позже подключим выбор тарифа, проверку фото, анализ, кнопку "Сгенерировать варианты?"
      const flowMap = {
        flow_free:
          "✅ Выбран: FREE\n\n" +
          "Этот режим доступен 1 раз.\n" +
          "Дальше мы попросим фото (с проверкой качества), сделаем анализ и предложим кнопку генерации.\n\n" +
          "Пока это заглушка меню.",
        flow_basic:
          "✨ Выбран: BASIC (Форма + цвет)\n\n" +
          "Дальше: фото → проверка → анализ → кнопки генераций (по запросу).\n\n" +
          "Пока это заглушка меню.",
        flow_pro:
          "🌈 Выбран: PRO (Форма + цвет + акцент)\n\n" +
          "Дальше: фото → проверка → анализ → генерации цвета/ярких оттенков (по запросу).\n\n" +
          "Пока это заглушка меню.",
        flow_premium:
          "💎 Выбран: PREMIUM (Полный образ)\n\n" +
          "Дальше: фото → проверка → анализ → биозавивка и серьги (по запросу).\n\n" +
          "Пока это заглушка меню.",
        flow_colorref1:
          "🎨 Выбран: COLOR REF 1\n\n" +
          "Проверка 1 цвета по референсу.\n" +
          "Нужно: референс цвета + твоё фото.\n\n" +
          "Пока это заглушка меню.",
        flow_colorref10:
          "🎨 Выбран: COLOR REF 10\n\n" +
          "Пакет 10 генераций цвета по референсам.\n" +
