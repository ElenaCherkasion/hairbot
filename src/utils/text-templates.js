...
const consentPd = `Согласие на обработку персональных данных
...
const consentThird = `Согласие на передачу персональных данных третьим лицам
...
const payments = `Правила оплаты и возврата
...
const photoInstructions = `📸 Требования к фото:
...
Опишите, пожалуйста, что произошло (кратко и понятно).
...
По вопросам оплаты, работы сервиса и персональных данных:
${SUPPORT_EMAIL}
`;

export default {
  docs: { consentPd, privacy, consentThird, payments },
  tariffs,
  consentScreen,
  photoInstructions,
  deleteWarning,
